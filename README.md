...
Collects temperature and rain data from `innov8dev.com/sampleapi/getdata.php` every 2 seconds for 10 minutes. Saves results to `data.csv` in MST timezone (UTC-7).
